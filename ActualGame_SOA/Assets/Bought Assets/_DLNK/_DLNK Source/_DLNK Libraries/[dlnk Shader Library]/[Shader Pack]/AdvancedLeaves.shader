...
///////// Gloss:
                ...
                float gloss = 1.0 - (lerp( _SmoothnessMap_var.r, _MetallicGlossMap_var.a, _MetalAlphaGloss )*_Glossiness); // Convert roughness to gloss
                float perceptualRoughness = (lerp( _SmoothnessMap_var.r, _MetallicGlossMap_var.a, _MetalAlphaGloss )*_Glossiness);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float4 _SmoothnessMap_var = tex2D(_SmoothnessMap,TRANSFORM_TEX(i.uv0, _SmoothnessMap));
                float roughness = (lerp( _SmoothnessMap_var.r, _MetallicGlossMap_var.a, _MetalAlphaGloss )*_Glossiness);
